...
gdsc_ge = pd.read_csv("data/processed/gdsc_cell_ge.csv", encoding='utf-8').fillna(0).set_index('CCL')
ctrp_ge = pd.read_csv('data/processed/ctrp_cell_ge.csv', encoding='utf-8').fillna(0).set_index('CCL')
gdsc_dr = pd.read_csv('data/processed/gdsc_poz_dr.csv', encoding='utf-8').fillna(0)
ctrp_dr = pd.read_csv('data/processed/ctrp_poz_dr.csv', encoding='utf-8').fillna(0)
